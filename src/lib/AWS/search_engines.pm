...
# 	     added eniro.no (Norway) [https://@@SOURCEFORGE_NET_DOMAIN@@/forum/message.php?msg_id=3134783]
# 	     added GPU p2p search http://search.centraldatabase.org/
# 	     added mail.tiscali to "not search engines list" [https://@@SOURCEFORGE_NET_DOMAIN@@/forum/message.php?msg_id=3166688]
# 	     added Ask group's "mysearch"
# 	     added sify.com (India)
# 	     added sogou.com (Cina) [https://@@SOURCEFORGE_NET_DOMAIN@@/forum/message.php?msg_id=3501603]
# 	     Ask changes:
# 	     - added Ask Japan (ask.jp)	
# 	     - break out Ask new country level variants (DE, ES, FR, IT, NL)
# 	     - updated Ask name from Ask Jevees
# 	     - added Ask q= parameter - many recent searches probably not recognized; [https://@@SOURCEFORGE_NET_DOMAIN@@/forum/message.php?msg_id=3465444]
# 	     - updated Ask uk (new uk.ask.com added to older ask.co.uk)
# 	     updated voila kw|rdata parameter [https://@@SOURCEFORGE_NET_DOMAIN@@/forum/message.php?msg_id=3373912]
...
#		exists https://@@SOURCEFORGE_NET_DOMAIN@@/forum/message.php?msg_id=3025426
