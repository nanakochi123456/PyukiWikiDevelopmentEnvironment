...
# 2005-09-16	added link for http://linkchecker.@@SOURCEFORGE_NET_DOMAIN@@/
...
# 2006-02-01    
#		added heritrix https://@@SOURCEFORGE_NET_DOMAIN@@/forum/message.php?msg_id=3550202
#		added Zeus Webster Pro https://@@SOURCEFORGE_NET_DOMAIN@@/forum/message.php?msg_id=3141164
...
#		added Bookmark-Manager http://bkm.@@SOURCEFORGE_NET_DOMAIN@@/
#		added cbn00glebot 
...
#		added GPU p2p crawler http://gpu.@@SOURCEFORGE_NET_DOMAIN@@/search_engine.php
#		added HooWWWer http://cosco.hiit.fi/search/hoowwwer/
#		added HPPrint 
#		added HTMLParser http://htmlparser.@@SOURCEFORGE_NET_DOMAIN@@/
...
#		added PyQuery http://@@SOURCEFORGE_NET_DOMAIN@@/projects/pyquery/
...
'feedcrawl','FeedCrawl by feed@aobo.combine',
...
'bookmark\-manager','<a href="http://bkm.@@SOURCEFORGE_NET_DOMAIN@@/" title="Bookmark-Manager home page [new window]" target="_blank">Bookmark-Manager</a>',
'boris', 'Boris',
...
'gpu_p2p_crawler','<a href="http://gpu.@@SOURCEFORGE_NET_DOMAIN@@/search_engine.php" title="Bot home page [new window]" target="_blank">GPU p2p crawler</a>',
'grub','Grub.org',
...
'hpprint','HPPrint',
'htmlparser','<a href="http://htmlparser.@@SOURCEFORGE_NET_DOMAIN@@/" title="HTMLParser home page [new window]" target="_blank">HTMLParser</a>',
...
'linkbot','LinkBot',
'linkchecker','<a href="http://linkchecker.@@SOURCEFORGE_NET_DOMAIN@@/" title="Bot home page [new window]" target="_blank">LinkChecker</a>',
...
'pyquery','<a href="http://@@SOURCEFORGE_NET_DOMAIN@@/projects/pyquery/" title="PyQuery home page [new window]" target="_blank">PyQuery</a>',
